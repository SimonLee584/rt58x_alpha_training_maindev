...
/**
 * \defgroup CM3MCU CM3 mcu
 * \ingroup RT58X_DRIVER
 * \brief  Define CM3 mcu definitions, structures, and functions
 * @{
 */
...
#include "system_mcu.h"                         /* CM3 MCU example System include file */

/**
 * \brief           Device Specific Peripheral registers structures
 */
#if defined(__CC_ARM)
#pragma anon_unions
#endif
...
/**
  ...
  * \note           The input port must be 32-bit aligned
  */
...
#define TRUE (1UL)                              /*!< Boolean true, define to use in
                                                 API parameters or return value */
#define FALSE (0UL)                             /*!< Boolean false, define to use in
                                                 API parameters or return value */

#define ENABLE  (1UL)                           /*!< Enable, define to use in API
                                                 parameters */
#define DISABLE (0UL)                           /*!< Disable, define to use in API
                                                 parameters */
...
#define GET_BYTE0(u32Param)(((u32Param) & BYTE0_Msk))       /*!< Extract Byte 0
                                                 (Bit  0~ 7) from parameter u32Param */
#define GET_BYTE1(u32Param)(((u32Param) & BYTE1_Msk) >> 8)  /*!< Extract Byte 1
                                                 (Bit  8~15) from parameter u32Param */
#define GET_BYTE2(u32Param)(((u32Param) & BYTE2_Msk) >> 16) /*!< Extract Byte 2
                                                 (Bit 16~23) from parameter u32Param */
#define GET_BYTE3(u32Param)(((u32Param) & BYTE3_Msk) >> 24) /*!< Extract Byte 3
                                                 (Bit 24~31) from parameter u32Param */

/**
 * \brief           Peripheral Driver API Header
 */
#include "flashctl.h"
#include "gpio.h"
...
/**
 * \brief           Set debug port as uart0
 */
#define DEBUGPORT 0

/**
 * \brief           This is a software breakpoint, which will stop the firmware 
 *                  when using ICE debugging
 */
#define BREAK()                                                                \
    do {                                                                       \
...
/*@}*/ /* end of RT58X_DRIVER CM3MCU */

#ifdef __cplusplus
}
#endif

#endif /* End of CM3MCU_CM3_H */
