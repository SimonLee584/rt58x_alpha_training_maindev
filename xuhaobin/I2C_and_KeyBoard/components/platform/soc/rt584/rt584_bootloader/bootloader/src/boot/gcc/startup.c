...
void bootloader_uart1_handler        (void) __attribute__ ((weak, alias("Default_Handler")));
void bootloader_uart2_handler        (void) __attribute__ ((weak, alias("Default_Handler")));
...
const VECTOR_TABLE_Type __VECTOR_TABLE[64] __VECTOR_TABLE_ATTRIBUTE =
{
    ...
    bootloader_uart1_handler,                 /*   17 UART1 Handler */
    bootloader_uart2_handler,                 /*   18 UART2 Handler */
    0,                                        /*   19 Reserved */
    ...
    (VECTOR_TABLE_Type)(MAGIC_HEADER_NUMBER),  /*   27 For Magic image Header number */
    (VECTOR_TABLE_Type)((CONFIG_BOOTLOADER_MAIN_VERSION<<16)|CONFIG_BOOTLOADER_MINOR_VERSION),       /*   28 Bootloader Version */
