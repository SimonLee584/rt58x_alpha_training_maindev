 ...
 * \return          function status
 */
int hosal_pwm_multi_fmt1_duty(uint32_t id, hosal_pwm_dev_t *dev, uint32_t element, uint8_t duty);
 ...
 * \return          function status
 */
int hosal_pwm_multi_fmt0_duty(uint32_t id, hosal_pwm_dev_t *dev, uint32_t element, uint8_t thd1_duty, uint8_t thd2_duty);
 ...
 * \details
 */
int hosal_pwm_multi_fmt1_count(uint32_t id, hosal_pwm_dev_t *dev, uint32_t element, uint32_t count);
 ...
 * \details
 */
int hosal_pwm_multi_fmt0_count(uint32_t id, hosal_pwm_dev_t *dev, uint32_t element, uint32_t thd1_Count, uint32_t thd2_count);
