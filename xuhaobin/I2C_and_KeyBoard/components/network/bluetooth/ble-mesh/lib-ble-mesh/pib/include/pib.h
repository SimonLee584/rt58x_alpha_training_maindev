...
#define PROD_DATA_FLASH_ADDRESS           ((FLASH_END_ADDR(( (flash_get_deviceinfo() >> FLASH_SIZE_ID_SHIFT) & 0xFF )) - 0x2000/*8K reserved for BLE bonding*/) - 0x4000)
#define APP_KEY_FLASH_ADDRESS             ((FLASH_END_ADDR(( (flash_get_deviceinfo() >> FLASH_SIZE_ID_SHIFT) & 0xFF )) - 0x2000/*8K reserved for BLE bonding*/) - 0x3000)
#define BIND_TABLE_FLASH_ADDRESS          ((FLASH_END_ADDR(( (flash_get_deviceinfo() >> FLASH_SIZE_ID_SHIFT) & 0xFF )) - 0x2000/*8K reserved for BLE bonding*/) - 0x2000)
#define MDL_SUBSCRIBE_INFO_FLASH_ADDRESS  ((FLASH_END_ADDR(( (flash_get_deviceinfo() >> FLASH_SIZE_ID_SHIFT) & 0xFF )) - 0x2000/*8K reserved for BLE bonding*/) - 0x1000)  // for server device


#define DEVICE_LIST_FLASH_ADDRESS         ((FLASH_END_ADDR(( (flash_get_deviceinfo() >> FLASH_SIZE_ID_SHIFT) & 0xFF )) - 0x2000/*8K reserved for BLE bonding*/) - 0x1000)  // for client device
